...
class AudioBook(Book):
    ...
    def duration(self) -> float:
        """Продолжительность аудиокниги в часах (положительное число)."""
...
if __name__ == '__main__':
    ...
    # paper_book.name = "Новое название"  # AttributeError
    # Проверка валидации
    # paper_book.pages = -10  # ValueError
    # audio_book.duration = "долго"  # TypeError